...
const ManageUsers = () => {
    ...
    return (
        <>
            <Card>
                <Helmet>
                    <title>Manage Users | BB-Vote</title>
                </Helmet>
                <CardHeader>
                        ...
                        <TableBody>
                            {(searchTerm ? searchedUsers : users).map((user, index) => (
                                <TableRow key={user?._id}>
                                    ...
                                    <TableCell><Badge className={user?.role === "admin" ? "capitalize bg-customGreen px-[23px] py-1" : "capitalize bg-customNil px-6 py-1"}>{user?.role === 'admin' ? 'Yes' : 'No'}</Badge></TableCell>

                                    <TableCell><Badge className={user?.isPremium === true ? "capitalize bg-customGreen px-[19px] py-1" : "capitalize bg-customNil px-6 py-1"}>{user?.isPremium === true ? "Premium" : "Normal"}</Badge></TableCell>
                                    <TableCell>
                                        <DropdownMenu>
